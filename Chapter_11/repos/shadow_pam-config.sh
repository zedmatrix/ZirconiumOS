...
func_list=(FAIL_DELAY  FAILLOG_ENAB  LASTLOG_ENAB  MAIL_CHECK_ENAB  OBSCURE_CHECKS_ENAB
...
prog_list=(chfn chgpasswd chsh groupadd groupdel groupmems groupmod useradd userdel usermod)
